...
function verifyTextLength(e) {
  ...
  if (textarea.value.length > 50 && textarea.value.length < 100000) {
...
function copyData(e) {const textArea = document.getElementById("text_to_summarize");
const submitButton = document.getElementById("submit-button");
const summarizedTextArea = document.getElementById("summary");
const copyButton = document.getElementById("copy-button");
...
function copyData(e) {
  copyButton.classList.add("submit-button--loading");
if(summarizedTextArea.value !== "") 
{navigator.clipboard.writeText(summarizedTextArea.value);
 copyButton.classList.remove("submit-button--loading");
